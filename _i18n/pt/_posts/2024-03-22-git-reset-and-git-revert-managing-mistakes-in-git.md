...
### Soft reset
Soft reset move o ponteiro HEAD para o commit especificado enquanto preserva as alterações na área de preparação. Isso permite que você recommita as alterações ou faça modificações adicionais antes de confirmar.
...
### Hard reset
Um hard reset move o ponteiro HEAD para um commit especificado e redefine tanto a área de preparação quanto o diretório de trabalho para corresponder. Todas as alterações feitas após este commit serão descartadas permanentemente.
...
Suponha que você já colocou algumas alterações na área de preparação e deseja movê-las para a área de trabalho. O seguinte comando desestagia um arquivo especificado, removendo-o da área de preparação enquanto preserva as alterações no diretório de trabalho.
...
Para aqueles que preferem recursos visuais, aqui está uma tabela destacando as principais distinções entre os com

andos.

| Recurso           | git reset                                 | git revert                                      |
|-------------------|---------------------------------------------|---------------------------------------------------|
| Operação          | Rewrites commit history                     | Creates new commit to reverse changes              |
| Efeito no histórico | Rewinds to specified commit               | Reverte as alterações do commit especificado       |
...
| Perda de histórico | Pode resultar na perda de alterações não confirmadas | Preserva o histórico de commit, cria um novo commit de reversão |
